...
https://airsl2.gesdisc.eosdis.nasa.gov/data/Aqua_AIRS_Level2/AIRX2RET.006/2002/249/AIRS.2002.09.06.240.L2.RetStd.v6.0.7.0.G13202075916.hdf
    ...
    urls,start_time,end_time = get_CMRgranurls('AIRIBRAD','005','2002.08.30','2003.09.01')
    print(datetime.datetime.now())
    print('Getting all AIRS L2 Granules within 100 km of New Orleans')
    print(datetime.datetime.now())
    circle_urls,start_time,end_time = get_CMRgranurls('AIRIBRAD','005','2002.08.30','2003.09.01',lon=-90.07,lat=29.95,rad_km=100)
    print(datetime.datetime.now())
    print('Getting all AIRS L2 Granules that overlap with NINO4 region')
    print(datetime.datetime.now())
    bb_urls,start_time,end_time = get_CMRgranurls('AIRIBRAD','005','2002.08.30','2003.09.01',lon=[160,-150],lat=[-5,5]) # Nino 4 region crosses the dateline
    print(datetime.datetime.now())
