import geoutils
import urllib2 # In python 2 it was urllib2
...
def get_CMROSurls(ShortName,versionID,start_time,end_time,lon=None,lat=None,rad_km=None):
    """
...
for link in links:
    ...
    for start_time_seg,end_time_seg in zip(start_times,end_times):
        ...
        xml_str = urllib2.urlopen(opensearch_string,timeout=120).read()
...
https://airsl2.gesdisc.eosdis.nasa.gov/data/Aqua_AIRS_Level2/AIRX2RET.006/2002/249/AIRS.2002.09.06.240.L2.RetStd.v6.0.7.0.G13202075916.hdf
    ...
    urls,xml_str,start_time,end_time = get_CMROSurls('AIRS2RET','006','2002.09.06','2002.09.07')
